...
This component is crucial because vector similarity alone doesn’t guarantee relevance; 
documents might be semantically similar but contextually inappropriate."""
